...
const STOCK_BENEFITS = [
  { stock_id: 6, ticker: 'ASS', name: 'Alcoholics Synonymous', shares: 1000000, type: 'Active', frequency: 7, description: '1x Six Pack of Alcohol', item_id: 817 },
  ...
  { stock_id: 12, ticker: 'ELT', name: 'Empty Lunchbox Traders', shares: 5000000, type: 'Passive', frequency: null, description: '10% Home Upgrade Discount (Property)', item_id: null },
  { stock_id: 13, ticker: 'EVL', name: 'Evil Ducks Candy Corp', shares: 100000, type: 'Passive', frequency: null, description: '1000 Happy', item_id: null },
  ...
  { stock_id: 16, ticker: 'CBD', name: 'Herbal Releaf Co.', shares: 350000, type: 'Passive', frequency: null, description: '50 Nerve', item_id: null },
  { stock_id: 17, ticker: 'HRG', name: 'Home Retail Group', shares: 10000000, type: 'Passive', frequency: null, description: '1x Random Property', item_id: null },
  ...
  { stock_id: 21, ticker: 'LAG', name: 'Legal Authorities Group', shares: 750000, type: 'Active', frequency: 7, description: '1x Lawyer Business Card', item_id: null },
  { stock_id: 22, ticker: 'LOS', name: 'Lo Squalo Waste Management', shares: 7500000, type: 'Passive', frequency: null, description: '25% Boost to mission credits and money earned', item_id: null },
  ...
  { stock_id: 27, ticker: 'MCS', name: 'Mc Smoogle Corp', shares: 350000, type: 'Passive', frequency: null, description: '100 Energy', item_id: null },
  ...
  { stock_id: 29, ticker: 'PRN', name: 'Performance Ribaldry Network', shares: 1000000, type: 'Active', frequency: 7, description: '1x Erotic DVD', item_id: 366 },
  { stock_id: 30, ticker: 'PTS', name: 'PointLess', shares: 10000000, type: 'Active', frequency: 7, description: '100 Points', item_id: 0 },
  ...
  { stock_id: 4, ticker: 'TGP', name: 'Tell Group Plc.', shares: 2500000, type: 'Passive', frequency: null, description: 'Company Advertising Boost', item_id: null },
  { stock_id: 8, ticker: 'TCT', name: 'The Torn City Times', shares: 100000, type: 'Active', frequency: 31, description: '$1,000,000', item_id: null },
  { stock_id: 5, ticker: 'TSB', name: 'Torn & Shanghai Banking', shares: 3000000, type: 'Active', frequency: 31, description: '$50,000,000', item_id: null },
  { stock_id: 9, ticker: 'TCC', name: 'Torn City Clothing', shares: 7500000, type: 'Active', frequency: 31, description: '1x Clothing Cache', item_id: null },
  { stock_id: 10, ticker: 'THS', name: 'Torn City Health Service', shares: 150000, type: 'Active', frequency: 7, description: '1x Box of Medical Supplies', item_id: 365 },
  ...
  { stock_id: 34, ticker: 'WLT', name: 'Wind Lines Travel', shares: 9000000, type: 'Passive', frequency: null, description: 'Private Jet Access (Travel)', item_id: null },
  { stock_id: 35, ticker: 'YAZ', name: 'Yazoo', shares: 1000000, type: 'Passive', frequency: null, description: 'Free Banner Advertising (Newspaper)', item_id: null },
];
