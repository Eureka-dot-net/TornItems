...
export default function GymComparison() {
  ...
  const migrateComparisonState = (state: Record<string, unknown>, totalDays: number): ComparisonState => {
    ...
    const section: TrainingSection = {
      ...
      stackedCandyJumpUsePointRefill: (state.stackedCandyJumpUsePointRefill as boolean) ?? false,
      stackedCandyJumpXanaxStacked: (state.stackedCandyJumpXanaxStacked as number) || 4,
      stackedCandyJumpStackOnNaturalEnergy: (state.stackedCandyJumpStackOnNaturalEnergy as boolean) ?? false,
    ...
    if (!shouldUseSavedStates) {
      ...
      const currentState: ComparisonState = {
        ...
        sections: [{
          ...
          stackedCandyJumpUsePointRefill: false,
          stackedCandyJumpXanaxStacked: 4,
          stackedCandyJumpStackOnNaturalEnergy: false,
